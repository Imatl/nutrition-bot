...
if not BOT_TOKEN:
    raise ValueError("BOT_TOKEN не найден! Создай .env файл или задай переменную окружения")
...
#ADMIN_IDS = [123456789] #you can put your user_id here for admin panel
...
async def main():
    if not ADMIN_IDS:
        print("⚠️  ВНИМАНИЕ: Не указан ADMIN_ID! Админ панель будет недоступна.")
        print("   Добавь ADMIN_ID в .env файл или задай ADMIN_IDS в коде")
